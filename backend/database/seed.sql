...
VALUES
    ('agent-conversational', 'Personal Assistant Agent', 'Primary Personal Assistant & Core Orchestrator', 'orchestrator', 'read_only', 'Primary personal agent responsible for understanding user goals, conversation, planning, and coordinating specialized agents, tools, and MCP capabilities.', 'bg-primary', 'gemini-3.6-flash', 0.2, 'You are ContextForge Personal Assistant Agent. You are the central reasoning brain and orchestrator. You focus on understanding user goals, conversation, strategic planning, and delegating execution to specialized Research and Action agents.', '[{"id":"c1","name":"Goal Understanding & Intent Analysis","description":"Comprehend user goals, context, and complex intent via multi-turn reasoning"},{"id":"c2","name":"Strategic Planning & Decomposition","description":"Decompose user objectives into structured execution plans and milestone steps"},{"id":"c3","name":"Sub-Agent & Tool Orchestration","description":"Coordinate and delegate execution to specialized Research and Action agents"}]'::jsonb, ARRAY['dispatch_action_worker', 'web_search', 'search_knowledge_vault'], ARRAY['skill-rfc-architect'], 'idle', 142, 99.6),
    ('agent-research', 'Research Agent', 'Information Retrieval & Grounding Intelligence', 'researcher', 'read_only', 'Dedicated intelligence agent for live web research grounding, source verification, and internal semantic vector retrieval (pgvector RAG).', 'bg-[#3b6ea5]', 'gemini-3.6-flash', 0.2, 'You are Research Agent. Search, read, and analyze information from live web sources and indexed vector knowledge bases, synthesizing cited analytical answers.', '[{"id":"c4","name":"Live Web Grounding & Citations","description":"Query Google Search, verify source authority, and synthesize cited findings"},{"id":"c5","name":"Internal Semantic Vector RAG","description":"Search indexed knowledge vault and vector embeddings for technical context"},{"id":"c6","name":"Cross-Source Information Synthesis","description":"Cross-reference data across web, documents, and memory into cohesive reports"}]'::jsonb, ARRAY['web_search', 'search_knowledge_vault', 'query_memory', 'obsidian_vault_reader', 'notion_search', 'notion_read_page'], ARRAY['skill-deep-web-research'], 'idle', 86, 99.4),
    ('agent-action', 'Action Agent', 'MCP Bridge & Side Execution Worker', 'execution_worker', 'sandbox_write', 'Specialized execution worker that connects to external services via MCP to create, format, and synchronize documents in Obsidian Vaults and Notion workspaces.', 'bg-[#9fbbe0]', 'gemini-3.6-flash', 0.2, 'You are Action Agent. Interface with external services via MCP protocols to execute file creation, formatting, and database updates in Obsidian vaults and Notion workspaces.', '[{"id":"c7","name":"MCP External Service Integration","description":"Bridge and execute write operations to connected MCP servers and external services"},{"id":"c8","name":"Obsidian Vault Synthesis","description":"Format and write atomic Markdown notes with frontmatter and backlinks in local vaults"},{"id":"c9","name":"Notion Database & Page Sync","description":"Create and synchronize structured document pages and wiki databases in Notion"}]'::jsonb, ARRAY['obsidian_vault_writer', 'obsidian_create_daily_note', 'notion_create_page', 'notion_update_database'], ARRAY['skill-obsidian-vault-synthesis'], 'idle', 74, 99.5)
ON CONFLICT (id) DO NOTHING;
